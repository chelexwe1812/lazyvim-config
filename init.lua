...
-- ConfiguraciÛn b·sica de Neovim
...
-- Otras configuraciones pueden ir aquÌ
...
require("lazy").setup({
		...
		config = function()
			...
			require("nvim-tree").setup({
				view = {
					...
					side = "left", -- Elige el lado donde aparecerá el árbol
				},
				filters = {
				...
				-- ConfiguraciÛn para no abrir nvim-tree autom·ticamente al iniciar
				-- open_on_setup = false,
	...
	-- NOTE: git lens config
	{
		...
		lazy = true,
		config = function()
			-- AquÌ puedes agregar alguna configuraciÛn adicional si es necesario.
			-- Por ejemplo, puedes agregar algunos mapeos de teclas para activar git-lens.
			vim.g.gitlens_map_default = true -- Esto habilitar· los keymaps predeterminados
		end,
	},
	...
	-- NOTE: Colorizer plugin, muestra los colores en el codigo.
	{
		"norcalli/nvim-colorizer.lua",
		config = function()
			require("colorizer").setup({
				"*", -- Archivos donde se aplica. '*' para todos.
				css = { rgb_fn = true }, -- Habilita funciones como `rgb(255, 0, 0)`
				html = { names = false }, -- Desactiva colores por nombre (ej. `red`).
			})
		end,
	},

	-- NOTE: Plugin para reslatar y resolver conflictos
...
-- 				config = function()
-- 					-- ConfiguraciÛn opcional, si deseas personalizar mapeos o opciones
-- 					vim.g.conflict_marker_enable_mappings = 1 -- Habilitar mapeos por defecto
-- 					-- Puedes personalizar los colores de los marcadores de conflicto aquÌ si lo deseas
-- 				end,
-- 			},
-- 		})
-- 		require('lazy').setup({
...
{ -- Useful plugin to show you pending keybinds.
	...
	--         nvimtree = true,
	--         telescope = true,
	--         -- Elimina la línea de lualine si da problemas
	--         -- lualine = true,
	--         -- Habilita más integraciones si es necesario
	--       },
	--     })
	...
	-- 	priority = 1000, -- Para asegurar que se cargue antes que otros plugins
	-- 	config = function()
